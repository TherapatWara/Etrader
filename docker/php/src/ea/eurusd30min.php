...
<div class="bannerP">
    ...
    <div class="wrapper">
        <div class="box">
            ...
            <h3>ผลการ Back test EURUSD 30min ตลอด 30 เดือน</h3><br>
            <img src="../pic/eur30graph.jpg" width=100% ><br><br>
            <img src="../pic/eur30report.jpg" width=100% ><br><br>
            <p>Symbol : EURUSD</p>
            <p>Time frame : 30min.</p>
            <a href="../download/E-trader.EurusdM30.zip" download><button class="download-button" >Download Now</button></a>
        </div>
    </div>
</div>
</body>
