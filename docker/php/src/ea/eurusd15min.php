...
<div class="bannerP">
    ...
    <div class="wrapper">
        <div class="box">
            ...
            <h3>ผลการ Back test EURUSD 15min ตลอด 30 เดือน</h3><br>
            <img src="../pic/eur15graph.jpg" width=100% ><br><br>
            <img src="../pic/eur15report.jpg" width=100% ><br><br>
            <p>Symbol : EURUSD</p>
            <p>Time frame : 15min.</p>
            <a href="../download/E-trader.EurusdM15.zip" download><button class="download-button" >Download Now</button></a>
        </div>
    </div>
</div>
</body>
