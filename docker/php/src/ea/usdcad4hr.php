...
<div class="bannerP">
    ...
    <div class="wrapper">
        <div class="box">
            ...
            <h3>ผลการ Back test USDCAD 1hr ตลอด 12 เดือน</h3><br>
            <img src="../pic/cad1graph.jpg" width=100% ><br><br>
            <img src="../pic/cad1report.jpg" width=100% ><br><br>
            <p>Symbol : USDCAD</p>
            <p>Time frame : 1hr.</p>
            <a href="../download/E-trader.UsdcadH1.zip" download><button class="download-button" >Download Now</button></a>
