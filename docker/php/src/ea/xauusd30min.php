...
<div class="bannerP">
    ...
    <div class="wrapper">
        <div class="box">
            ...
            <h3>ผลการ Back test XAUUSD 30min ตลอด 30 เดือน</h3><br>
            <img src="../pic/xau30graph.jpg" width=100% ><br><br>
            <img src="../pic/xau30report.jpg" width=100% ><br><br>
            <p>Symbol : XAUUSD</p>
            <p>Time frame : 30min.</p>
            <a href="../download/E-trader.XauusdM30.zip" download><button class="download-button" >Download Now</button></a>
